...
if (!isset($_GET['id'])) {
    header("Location: travelhistory.php");
    exit();
}
...
$sql = "SELECT t.*, u.full_name, u.email, u.phone_number, u.nid_number 
        FROM tickets t 
...
<div class="container" style="padding-top: 60px; padding-bottom: 30px;">
    <div class="card">
        <h2>Metro Rail Ticket Details</h2>
    ...
    <div style="text-align: center; margin-bottom: 15px;">
            <a href="travelhistory.php" class="back-btn">
                <i class="fas fa-arrow-left"></i> Back to Travel History
            </a>
